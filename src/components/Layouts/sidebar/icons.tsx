  ...
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width={24} height={24} {...props}>
      <path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 
        ...
        14h9.53c.75 0 1.41-.41 1.75-1.03l3.58-6.49a.996.996 0 00-.86-1.48H5.21L4.27 
        2H1v2h2l3.6 7.59-1.35 2.44C4.52 14.37 5.48 16 7 16h11v-2H7.42l.74-1.34z" />
    </svg>
  );
}

export function Purchase(props: React.SVGProps<SVGSVGElement>) {
  return (
   <svg viewBox="0 0 24 24" fill="currentColor" width={24} height={24} {...props}>
      <path d="M20 6h-4V4H8v2H4v2h16V6zm-9 4v4H8l4 4 4-4h-3v-4h-2zm-7 
        6v4h16v-4h-2v2H6v-2H4z" />
    </svg>
  );
}
...
export function Products(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width={24} height={24} {...props}>
      <path d="M21 8.5l-9-5-9 5 9 5 9-5zm0 2.24l-9 
        5-9-5V17l9 5 9-5v-6.26z" />
    </svg>
  );
}
...
export function Reports(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width={24} height={24} {...props}>
      <path d="M5 9h4v10H5V9zm5-5h4v15h-4V4zm5 8h4v7h-4v-7z" />
    </svg>
  );
}
