                ...
                <div className="mb-2 flex rounded-[7px] border-[1.5px] border-stroke py-[9px] pl-3 pr-3 outline-none transition focus:border-primary active:border-primary dark:border-dark-3 dark:bg-dark-2">
                    ...
                    {selected.length === 0 && (
                      <div className="flex-1">
                        <input
                          ...
                          className="h-full w-full appearance-none bg-transparent p-1 px-2 text-dark-500 outline-none dark:text-dark-600"
                  ...
                  <div className="flex items-center py-1 pl-1 pr-1">
                    <button
                      type="button"
                      onClick={open}
                      className="cursor-pointer text-dark-4 outline-none focus:outline-none dark:text-dark-600"
                    >
                      <svg
                        className="fill-current"
                        width="20"
