...
//     const errors: { name?: string; phone?: string; aadhaar?: string } = {}
...
//     if (newCustomer.aadhaar.trim()) {
//       const digits = newCustomer.aadhaar.replace(/\s+/g, "")
//       if (!/^\d{12}$/.test(digits)) {
...
//       setNewCustomer({ name: "", phone: "", aadhaar: "", address: "" })
...
//         await updateOrder( parseInt(id), orderInput)
//         toast({
//           title: "Success",
...
//                         {/* AADHAAR */}
//                         <div className="grid grid-cols-4 items-center gap-4">
//                           <Label htmlFor="aadhaar" className="text-right text-black">
//                             Aadhaar
//                           </Label>
//                           <div className="col-span-3 space-y-1">
//                             <Input
...
//                                 setNewCustomer({ ...newCustomer, aadhaar: value })
//                                 if (formErrors.aadhaar) {
//                                   setFormErrors({ ...formErrors, aadhaar: undefined })
//                                 }
//                               }}
//                               className={formErrors.aadhaar ? "border-red-500" : ""}
//                             />
//                             {formErrors.aadhaar && <p className="text-md text-red-500">{formErrors.aadhaar}</p>}
//                           </div>
//                         </div>
                        ...
                        <form onSubmit={customerForm.handleSubmit(handleAddCustomer)} className="space-y-6">
                                  ...
                                  <div className="col-span-3">
                                    <FormControl>
                                      <Input
                                        ...
                                        onBlur={() => {
                                          customerForm.trigger("phone")
                                        }}
                                        className={customerForm.formState.errors.phone ? "border-red-500" : ""}
                                      />
                                    </FormControl>
                          ...
                          <DialogFooter className="flex flex-col sm:flex-row-reverse sm:justify-center gap-2">
                            ...
                            <Button
                              ...
                              disabled={isLoading || customerForm.formState.isSubmitting}
                            >
                              {isLoading || customerForm.formState.isSubmitting ? (
                                <>
