...
//   return (
//     <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
//       <circle cx={29} cy={29} r={29} fill="#4ADE80" />
//       <path
//         d="M20 25h18v8H20z"
//         fill="#fff"
//         opacity="0.3"
//       />
//       <path
//         d="M39 22H19a1 1 0 00-1 1v12a1 1 0 001 1h20a1 1 0 001-1V23a1 1 0 00-1-1zm-1 10H20v-8h18v8z"
//         fill="#fff"
//       />
...
// export function ShoppingBagIcon(props: SVGPropsType) {
//   return (
//     <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
//       <circle cx={29} cy={29} r={29} fill="#FBBF24" />
//       <path
//         d="M38 23h-4v-2a5 5 0 10-10 0v2h-4a1 1 0 00-1 1v17a1 1 0 001 1h18a1 1 0 001-1V24a1 1 0 00-1-1zm-8 0h-4v-2a2 2 0 114 0v2z"
//         fill="#fff"
//       />
//     </svg>
//   )
...
//   return (
//     <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
//       <circle cx={29} cy={29} r={29} fill="#60A5FA" />
//       <path
//         d="M20 22h18a2 2 0 012 2v10a2 2 0 01-2 2H20a2 2 0 01-2-2V24a2 2 0 012-2zm0 3v1h18v-1H20z"
//         fill="#fff"
//       />
//     </svg>
//   )
...
// export function WalletIcon(props: SVGPropsType) {
//   return (
//     <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
//       <circle cx={29} cy={29} r={29} fill="#F472B6" />
//       <path
//         d="M20 23h18a2 2 0 012 2v8a2 2 0 01-2 2H20a2 2 0 01-2-2v-8a2 2 0 012-2zm12 3h4v4h-4v-4z"
//         fill="#fff"
//       />
//     </svg>
//   )
...
// export function AlertCircleIcon(props: SVGPropsType) {
//   return (
//     <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
//       <circle cx={29} cy={29} r={29} fill="#F87171" />
//       <path
//         d="M29 18a11 11 0 100 22 11 11 0 000-22zm0 4a1 1 0 011 1v6a1 1 0 11-2 0v-6a1 1 0 011-1zm0 10a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5z"
//         fill="#fff"
//       />
//     </svg>
//   )
...
export const Views = BarChart
export const Profit = DollarSign
export const CashIcon = TrendingUp
...
export function ClockIcon(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#818CF8" />
      <path
        d="M29 18a11 11 0 100 22 11 11 0 000-22zm0 2a9 9 0 110 18 9 9 0 010-18zm-.5 4v6h5a.5.5 0 110 1H28a.5.5 0 01-.5-.5v-6.5a.5.5 0 111 0z"
        fill="#fff"
      />
    </svg>
  )
