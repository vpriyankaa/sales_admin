      ...
      <>
        <div>
          <div className="flex flex-col md:flex-row w-full gap-4">
                    ...
                    <Dialog open={isAddingCustomer} onOpenChange={setIsAddingCustomer}>
                      ...
                      <DialogContent className="bg-white dark:bg-white">
                        ...
                        <DialogFooter className="flex flex-col sm:flex-row-reverse sm:justify-center gap-2">
                          <Button
                            className="color:  bg-green-600 text-white"
            ...
            {/* Gray background gap */}
            <div className="hidden md:block w-2 bg-gray-100"></div>

            {/* Right side - Order Summary */}
            <div className="w-full md:w-1/3 bg-white rounded-[10px] shadow-1 self-start">
              <OrderSummary
                cart={cart}
