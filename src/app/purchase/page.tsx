...
import { addCustomer, getCustomers, getParticulars, addOrder, getUnits } from "@/app/(home)/actions"
    ...
    <>
      ...
      {cart.length === 0 ? (
        <div className="max-w-4xl mx-auto bg-white rounded-[10px] shadow-1 p-6">
          <h2 className="text-2xl font-bold text-center text-black mb-4">Purchase</h2>
